...
class HomeController extends AbstractController
{
    ...
    public function displayRayons(Connection $connection)
    {
        $sqlCatParent = "SELECT CatID, CatTitre, CatLien, CatDescription, CatTitreReq FROM CENTRALE_ACHAT_V2.dbo.Categories WHERE CatSort > 0 AND CatIDParent = 0 ORDER BY CatSort";
        ...
        return $this->render('partials/Rayons_header.html.twig', ['rayons' => $Categories]);


    }


    public function displayEspacePrive(Connection $connection)
    {
        $sqlEspacePrive = "SELECT CatID, CatTitre, CatLien, CatTitreReq, CatDescription, CatTitreReq
        ...
        return $this->render('partials/EspacePrive_header.html.twig', ['espacePrive' => $espacesPrive]);
